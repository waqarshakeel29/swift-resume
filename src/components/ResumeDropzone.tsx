...
import { parseResumeFromPdf } from "@/app/lib/parse-resume-from-pdf";
import {
  getHasUsedAppBefore,
...
import styles from "./ResumeDropzone.module.scss";
  ...
  return (
    <div
      className={cx(styles.container, className, {
        [styles.hoveredBorderColor]: isHoveredOnDropzone,
        [styles["container-p1"]]: playgroundView,
        [styles["container-p2"]]: !playgroundView,
      })}
      onDragOver={(event) => {
        event.preventDefault();
    ...
    >
      <div
        className={cx("text-center", {
          "space-y-2": playgroundView,
          "space-y-3": !playgroundView,
        })}
      >
        {!playgroundView && (
          <Image
