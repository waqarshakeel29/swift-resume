...
export const InputGroupWrapper = ({
  ...
  <label className={cx(styles["input-group__label"], className)}>
    {label}
    {children}
  </label>
);

export const INPUT_CLASS_NAME = styles.input;
  ...
  return (
    <InputGroupWrapper label={label} className={wrapperClassName}>
      <textarea
        ref={textareaRef}
        name={name}
        className={cx(INPUT_CLASS_NAME, styles.textarea)}
        placeholder={placeholder}
        value={value}
        onChange={(e) => onChange(name, e.target.value)}
      />
  ...
  return (
    <InputGroupWrapper label={label} className={wrapperClassName}>
      <ContentEditable
        ...
        className={cx(styles.input, styles["content-editable"], {
          [styles["show-bullet-points"]]: showBulletPoints,
          [styles["hide-bullet-points"]]: !showBulletPoints,
        })}
